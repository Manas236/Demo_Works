...
**Tests:** **2,805 passed / 2 skipped** in the openpyxl **absent**, both client workbooks **absent**, global `C:\Program Files\Python310` (CPython 3.10.11), **no `.venv`**
...
reports **2,806 passed / 4 skipped** against the same commit, and read
