...
ROLE_NOTES = {
    ...
    "director": {
        ...
        "cannot": "**Change what a role means.** This is the single line "
                  ...
                  "— that would be the same escalation by another door. **Nor "
                  "can they touch an Owner's account at all**: not its "
                  "password, not its roles, not whether it is switched on. "
                  "Setting an Owner's password is signing in as an Owner, which "
                  "is the same door again with no role change needed to walk "
